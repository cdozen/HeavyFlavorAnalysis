...
'/store/data/Run2016B/ZeroBias/AOD/07Aug17_ver2-v1/90001/F6D14F20-AA98-E711-ADD3-0CC47A7C353E.root'
...
process.SKIMStreamBPHSkim = cms.OutputModule("PoolOutputModule",
    ...
    eventAutoFlushCompressedSize = cms.untracked.int32(5242880),
    fileName = cms.untracked.string('BPHSkim_2016_MiniBias.root'),
